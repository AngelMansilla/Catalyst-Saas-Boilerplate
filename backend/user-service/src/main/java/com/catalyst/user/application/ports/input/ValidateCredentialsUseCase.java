 ...
 * Used for traditional email/password login flows.
 * 
...
public interface ValidateCredentialsUseCase {
     ...
     * @throws com.catalyst.user.domain.exception.InvalidPasswordException if
     *                                                                     credentials
     *                                                                     invalid
     * @throws com.catalyst.user.domain.exception.UserNotActiveException   if
     *                                                                     account
     *                                                                     is
     *                                                                     disabled
     */
